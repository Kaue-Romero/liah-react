...
export function ProductCard({
  ...
  const resolvedStoreMode = effectiveStoreMode ?? storeMode;
  ...
  return (
    ...
    >
      <div className="divFotoProduto liah-react-product-photo-wrap">
        ...
        {!available && resolvedStoreMode ? <div className="tag-indisponivel small-tag">Indisponível</div> : null}
        {hasPromo ? <div className="liah-react-discount">{discount}% OFF</div> : null}
        {resolvedStoreMode && available ? (
          <button
