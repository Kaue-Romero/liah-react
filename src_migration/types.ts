...
export interface LiahPublicApi {
  init(containerId: string, options: LiahConfig): Promise<void> | void;
  ensureLoaded?(options: Record<string, unknown>): Promise<void>;
...
declare global {
  interface Window {
    LIAH?: LiahPublicApi;
    MyInterface?: LiahPublicApi & {
      pendingInit?: {
        elementId: string;
        config: LiahConfig;
      };
    };
    objetosLiah?: Record<string, unknown>;
    variaveisLiah?: Record<string, unknown>;
    scriptDirectory?: string;
    rootDirectory?: string;
    url_apis?: string;
    grupoLiah?: string | null;
    showToast?: (options: { messageText?: string; type?: ToastMessage['type']; staySeconds?: number }) => void;
    campanhaAtivaLiah?: Campaign;
    campanhasLiah?: Campaign[];
    nenhumDescontoSelecionado?: boolean;
  }
}
